package com.xmethod.xycode.utils.circularAnim;
...
public class CircularAnim {
                            ...
                            FullActivityBuilder.this.mTriggerView.postDelayed(new Runnable() {
                                public void run() {
                                    if(!FullActivityBuilder.this.mActivity.isFinishing()) {
                                        try {
                                            Animator e = ViewAnimationUtils.createCircularReveal(view, cx, cy, (float)finalRadius, FullActivityBuilder.this.mStartRadius);
    ...
    public static class VisibleBuilder {
        ...
        public void go() {
            this.go((OnAnimationEndListener)null);
        }
